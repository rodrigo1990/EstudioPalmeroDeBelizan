...
function displayCalling() {
	...
	$("#click2call_callbtn_mobile").hide();
	$("#click2call_hupbtn_mobile").show();
}
...
function displayReady2Call() {
	...
	$("#click2call_callbtn_mobile").show();
	$("#click2call_hupbtn_mobile").hide();
}
...
function init() {
    ...
    $("#click2call_callbtn_mobile").click(function() {
	displayCalling();
	if(nocon) {
		initVerto();
	} else {
    ...
    $("#click2call_hupbtn_mobile").click(function() {
    	if(cur_call != null) {
	        verto.hangup();
	        cur_call = null;
    	}
